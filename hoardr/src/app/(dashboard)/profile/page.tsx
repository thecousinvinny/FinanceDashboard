  ...
  const redraw = useCallback(() => {
    ...
    for (let gi = 0; gi < N; gi++) {
      ...
      if (isHov) {
        ...
        ctx.font      = '9px -apple-system,system-ui,sans-serif'
        ctx.fillStyle = net >= 0 ? `rgba(${incRgb},0.65)` : `rgba(${expRgb},0.65)`
      ...
      <div ref={cardRef} className="select-none"
        ...
        <div className="flex items-center gap-3 mb-3" style={{ flexWrap: 'wrap' }}>
          ...
          <div className="ml-auto flex flex-col items-end" style={{ gap: 1 }}>
            ...
            <span style={{ fontSize: 15, fontWeight: 700, fontFamily: 'var(--font-big-shoulders)', color: netTotal >= 0 ? 'var(--sem-income)' : 'var(--sem-expense)' }}>
