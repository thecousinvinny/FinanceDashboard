                                    ...
                                    {allDayEvs.slice(0, shownAllDay).map((ev, ei) => {
                                      ...
                                      return (
                                        ...
                                        >
                                          ...
                                          <span className={isPast ? 'cal-pill-title-past' : 'cal-pill-title'} style={{ fontSize: 10, color: isPast ? lightTextColor(evColor, true) : 'rgba(255,255,255,0.92)', fontFamily: 'var(--font-montserrat)', fontWeight: 500, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{ev.title}</span>
                                        </div>
                                      )
                                    })}
