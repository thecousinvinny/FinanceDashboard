                                      ...
                                      {spanLanes.map((lane, li) => {
                                        ...
                                        return (
                                          <div key={li}
                                            ...
                                            {isStart && <span style={{ fontSize: 9, color: isPast ? lightTextColor(bg, true) : 'rgba(255,255,255,0.92)', fontFamily: 'var(--font-montserrat)', fontWeight: 600, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{bar.ev.title}</span>}
                                          </div>
                                        )
                                      })}
                                    </div>
